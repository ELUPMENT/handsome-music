        ...
        <el-container>
            ...
            <el-aside width="210px">
                ...
                <el-menu default-active="/findMusic" :router="true">
                    ...
                    <el-submenu index="1">
                        <template slot="title"><span style="text-align:left;">创建的歌单</span></template>
                    <el-menu-item-group>
                    ...
                    <el-submenu index="2">
                        <template slot="title"><span>收藏的歌单</span></template>
                    <el-menu-item-group>                        
                        <el-menu-item :index="'/songlist/'+item.id" @click="changePlaylistId(item.id)"
                                      v-for="item in currentUserPlayList"
                                      v-if="item.subscribed"><i class="el-icon-s-order"></i>{{item.name}}
                        </el-menu-item>
                    </el-menu-item-group>
                    </el-submenu>
