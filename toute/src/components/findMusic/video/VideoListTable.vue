<template>
    <el-container style="margin-bottom: 55px;">
        <el-header>
            ...
            <el-dialog title="全部标签" :visible.sync="tagDialogTableVisible" :model="false"
        ...
        <el-main>
            ...
            <el-row :gutter="10">
                ...
                <el-col :span="6" v-for="(item,index) in videoList" style="margin-top: 20px;position:relative;"
                        :key="index">
                    ...
                    <h1 @click="toVideoPage(item.data.vid)" style="cursor:pointer;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">{{item.data.title}}</h1>
